 ...
 * @dev Storage layout for the deployer address used in implementation whitelist initialization
...
library LibImplementationWhitelistDeployerAddressStorage {
    ...
    /// keccak256("onchain.custody.implementation.whitelist.deployer.storage")
    bytes32 internal constant STORAGE_SLOT = keccak256("onchain.custody.implementation.whitelist.deployer.storage");
