...
DEPLOYER_SAFE_NONPROD=$(extract_address "$SAFE_MULTISIG_NONPROD_OUTPUT" "Deployer Safe")
...
DEPLOYER_SAFE_PROD=$(extract_address "$SAFE_MULTISIG_PROD_OUTPUT" "Deployer Safe")
